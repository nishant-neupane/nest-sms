...
export const UsersOverview = () => {
  ...
  return (
    <>
      <div className="bg-white p-5 rounded-lg sm:col-span-2 border border-gray-100">
        <div className="flex justify-between items-center mb-4">
          ...
          <button 
            ...
            className="font-bold text-sm text-[#4A99FF] border border-[#4A99FF] px-5 py-1 rounded-full hover:scale-[1.03] transition-all duration-300 cursor-pointer"
          >
            + Add member
          </button>
        </div>
